          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12 animate-slide-up">
              ...
              <p className="text-2xl text-white/90 font-semibold">
                Global Yoga. Its Entertaining, Engaging &amp; Skillful Yoga Learning VoD Service
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-8 sm:p-12 space-y-6 animate-fade-in">
              <p className="text-lg text-white/90 leading-relaxed">
                At Global Yoga, we believe that wellness should be accessible, flexible, and empowering. That's why we created a modern Video-on-Demand (VOD) yoga platform designed to bring the benefits of yoga directly to your screen — anytime, anywhere.
              </p>
              ...
              <p className="text-lg text-white/90 leading-relaxed">
                As a VOD (Video-on-Demand) yoga subscription service, Global Yoga bridges the gap between traditional yoga practice and the demands of today's digital lifestyle. No more fixed schedules or crowded studios — just pure, uninterrupted yoga whenever you need it.
              </p>
              ...
              <p className="text-xl text-white font-semibold text-center pt-4">
                Join the Global Yoga movement today — and let's breathe, move, and grow together.
              </p>
            </div>
